...
**A Lista do Google Dorks** “Google Hacking” é principalmente usada para extrair informações confidenciais do Google usando termos de pesquisa avançados que ajudam os usuários a pesquisar o índice de um site específico, tipo de arquivo específico e algumas informações interessantes de sites não seguros.

**A lista do Google Dorks 2019** pode descobrir informações incríveis, como endereços e listas de e-mail, credenciais de login, arquivos confidenciais, vulnerabilidades de sites e até informações financeiras (por exemplo, dados de cartões de pagamento).

Aqui pode ver um exemplo para entender como a senha do Google Darks é usada pelos hackers para obter informações confidenciais de sites específicos.

- “inurl: domain/” “additional dorks

Um hacker simplesmente usaria os parâmetros desejados da seguinte maneira:

- inurl = a URL do site que você deseja consultar
- domain = o domínio para o site
- dorks = os subcampos e parâmetros que um hacker deseja verificar

A melhor maneira de usar legalmente o Google dorks é encontrar vulnerabilidades em seu próprio site.

Também podemos usar outras pesquisas arquivadas que não o URL que ajudarão a descobrir muitas informações sobre um site.
...
## Alguns dos exemplos do Google dorks:

**info**: a consulta [info:] apresentará algumas informações que o Google possui sobre essa página da web. Por exemplo, [info: www.google.com] mostrará informações sobre a página inicial do Google. Observe que não pode haver espaço entre as informações: e o URL da página da web.

**link**: a consulta [link:] listará páginas da web que possuem links para a página da web especificada. Por exemplo, [link: www.google.com] listará páginas da web que possuem links apontando para a página inicial do Google. Observe que não pode haver espaço entre o "link:" e o URL da página da web.

**site**: se você incluir [site:] em sua consulta, o Google restringirá os resultados a esses sites no domínio especificado.

Por exemplo, **[help site:www.google.com]** encontrará páginas sobre ajuda em www.google.com. **[help site:com]** encontrará páginas sobre ajuda em URLs .com. Observe que não pode haver espaço entre o "site:" e o domínio.

**inurl**: se você incluir [inurl:] em sua consulta, o Google restringirá os resultados a documentos que contenham essa palavra no URL. Por exemplo, [inurl: google search] retornará documentos que mencionam a palavra "google" em seu URL e menciona a palavra "pesquisar" em qualquer lugar do documento (URL ou não).

## Lista mais importante do Google Dorks 2019
...
Autor: [BALAJI N](https://gbhackers.com/author/balaji/)
