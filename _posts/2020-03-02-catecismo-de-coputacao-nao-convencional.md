...
Tentar provar se P = NP é provavelmente tão sem esperança quanto tentar fisicamente um hipercomputador ( [Davis, 2004](https://www.frontiersin.org/articles/10.3389/frobt.2014.00010/full#B6) ), um computador que pode calcular funções (como o problema da parada) que uma máquina de Turing clássica não pode. É fundamental estar ciente de possíveis limites fundamentais teóricos e práticos, soltos e rígidos, a fim de eliminar quaisquer projetos de “missão impossível” desde o início. Um artigo recente de [Markov (2014)](https://www.frontiersin.org/articles/10.3389/frobt.2014.00010/full#B12) resume os limites fundamentais relevantes para as tecnologias emergentes. [Lloyd (2000)](https://www.frontiersin.org/articles/10.3389/frobt.2014.00010/full#B11) introduziu várias ab initiolimites e o “melhor laptop” em seu artigo de 2000. Embora os limites frouxos possam ser bem flexibilizados com a execução de certos truques, os limites apertados não cedem. Por exemplo, a máquina de Turing em aceleração ( [Teuscher e Sipper, 2002](https://www.frontiersin.org/articles/10.3389/frobt.2014.00010/full#B17) ) pode resolver o Problema da Parada em tempo linear na teoria, mas é obviamente, não é possível implementar fisicamente essa máquina, porque isso acabaria por exigir operações infinitamente rápidas, pelo menos se o observador e o computador estivessem no mesmo quadro de referência.

## Programação

Muitos substratos não convencionais, como uma sopa de filamentos de DNA, E. coli ou colônias de formigas, oferecem dinâmicas interessantes, mas não está claro como podemos aproveitá-las para uma finalidade útil, ou seja, calcular uma função no sentido de uma máquina de Turing . [Crutchfield et al. (2010)](https://www.frontiersin.org/articles/10.3389/frobt.2014.00010/full#B5) descreveram essa questão como uma ponte entre a computação intrínseca e a projetada . A questão mais profunda está relacionada ao controle e programação da dinâmica intrínseca, que levaria à computação projetada (ou útil). Como Stepney afirma em [Stepney (2012)](https://www.frontiersin.org/articles/10.3389/frobt.2014.00010/full#B15), “Nossa capacidade de explorar computação não convencional é parcialmente prejudicada pela falta de formalismos de programação correspondentes: precisamos de modelos para criar, compor e raciocinar sobre programas executados nesses substratos”.
...
- Amos, M., Stepney, S., Doursat, R. e Vico, FJ (2012). Trégua: uma ação de coordenação para computação não convencional. Int. J. Unconv. Comput. 8, 333-337.
- [Google Scholar](http://scholar.google.com/scholar_lookup?title=Truce:+a+coordination+action+for+unconventional+computation&author=M.+Amos&author=S.+Stepney&author=R.+Doursat&author=F.+J.+Vico&journal=Int.+J.+Unconv.+Comput.&publication_year=2012&volume=8&pages=333%E2%80%93337)
- Apte, P. e Scalise, G. (2009). O forro de prata da recessão. IEEE Spectr. 46, 46-51.
- [Google Scholar](http://scholar.google.com/scholar_lookup?title=The+recession%E2%80%99s+silver+lining&author=P.+Apte&author=G.+Scalise&journal=IEEE+Spectr.&publication_year=2009&volume=46&pages=46%E2%80%9351)
...
Autor: [Christof Teuscher](http://www.frontiersin.org/people/u/143665)

[Artigo Original](https://www.frontiersin.org/articles/10.3389/frobt.2014.00010/full)
