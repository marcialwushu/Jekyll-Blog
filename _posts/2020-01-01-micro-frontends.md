...
* [Abordagens de integração](#abordagens-de-integração)
    * [Composição do modelo do lado do servidor](#composição-do-modelo-do-lado-do-servidor)
    * [Integração em tempo de compilação](#integração-em-tempo-de-compilação)
    * [Integração em tempo de execução via iframes](#integração-em-tempo-de-execução-via-iframes)
    * [Integração em tempo de execução via JavaScript](#integração-em-tempo-de-execução-via-javascript)
    * [Integração em tempo de execução via Web Components](#integração-em-tempo-de-execução-via-web-components)
* [Styling](#styling)
* [Bibliotecas de componentes compartilhados](#bibliotecas-de-componentes-compartilhados)
* [Comunicação entre aplicativos](#comunicação-entre-aplicativos)
* [Comunicação de back-end](#comunicação-de-back-end)
* [Teste](#teste)
* [O exemplo em detalhes](#o-exemplo-em-detalhes)
    * [O recipiente](#o-recipiente)
    * [Os micro frontends](#os-micro-frontends)
    * [Comunicação entre aplicativos via roteamento](#comunicação-entre-aplicativos-via-roteamento)
    * [Conteúdo comum](#conteúdo-comum)
    * [A infraestrutura](#a-infraestrutura)
* [Desvantagens](#desvantagens)
    * [Tamanho da carga útil](#tamanho-da-carga-útil)
    * [Diferenças de ambiente](#diferenças-de-ambiente)
    * [Complexidade operacional e de governança](#complexidade-operacional-e-de-governança)
* [Conclusão](#conclusão)
